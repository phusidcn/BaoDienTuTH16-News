...
router.post('/forgot', (req, res, next) => {
    async.waterfall([
            ...
            User.findOne({
                ...
                .then((user) => {
                    if (!user) {
                        ...
                        return res.redirect('/employee/editors/forgot')
                    }
        ...
        function (token, user, done) {
            ...
            let mailOptions = {
                ...
                text: 'You are receiving this because you (or someone else) have requested the reset of the password for your account.\n\n' +
                    ...
                    'http://' + req.headers.host + '/employee/editors/reset/' + token + '\n\n' +
        ...
        res.redirect('/employee/editors/forgot')
    })
})
